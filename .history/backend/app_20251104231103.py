...
def audit_log(action, user_id=None, entity_type=None, entity_id=None, details=None, request_info=None):
    ...
    try:
        ...
        # Create audit log entry - only include non-null values that match the model
        ...
        db.session.flush()  # Use flush instead of commit to avoid breaking existing transactions
        ...
        return audit_entry.id  # Return the ID for potential use
