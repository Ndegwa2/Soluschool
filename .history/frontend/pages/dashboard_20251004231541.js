...
export default function Dashboard() {
  ...
  const sortTable = (col) => {
    // For simplicity, sort the displayed logs
    // In real app, sort on server or client
  ...
  return (
    <ProtectedRoute allowedRoles={['parent', 'admin']}>
      <main className="container">
        ...
        <div className="page-sub">Quick snapshot of today's activity and tools.</div>
              ...
              <div className="card-body">
                ...
                <div className="table-wrap">
                  <table id="history-table">
                    <thead>
                      <tr>
                        <th data-col="child" onClick={() => sortTable('child')}>Child ▾</th>
                        <th data-col="gate" onClick={() => sortTable('gate')}>Gate</th>
                        <th data-col="time" onClick={() => sortTable('time')}>Timestamp</th>
