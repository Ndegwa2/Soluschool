            ...
            {role === 'parent' ? (
              <>
                <div className="bg-white p-6 rounded-lg shadow">
                  ...
                  <p className="text-2xl">{children?.children?.length || 0}</p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow">
              ...
              <>
                <div className="bg-white p-6 rounded-lg shadow">
                  ...
                  <p className="text-2xl">{analytics?.total_pickups || 0}</p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow">
                  <h3 className="text-lg font-semibold">Peak Hour</h3>
                  <p className="text-2xl">{analytics?.peak_hour ? `${analytics.peak_hour}:00` : 'N/A'}</p>
                </div>
                <div className="bg-white p-6 rounded-lg shadow">
                  <h3 className="text-lg font-semibold">Visitors Today</h3>
                  <p className="text-2xl">{analytics?.visitors || 0}</p>
                </div>
              </>
            )}
          </div>
