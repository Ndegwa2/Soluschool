...
export default function Dashboard() {
  ...
  console.log('DashboardPage: Children data:', children, 'error:', childrenError)
  const { data: qrList, error: qrError } = useSWR('/api/qr/list', fetcher)
  console.log('DashboardPage: QR list data:', qrList, 'error:', qrError)
  const { data: logs, error: logsError } = useSWR('/api/logs', fetcher)
  console.log('DashboardPage: Logs data:', logs, 'error:', logsError)
  const { data: analytics, error: analyticsError } = useSWR(role === 'admin' ? '/api/analytics/summary' : null, fetcher)
  console.log('DashboardPage: Analytics data:', analytics, 'error:', analyticsError)
