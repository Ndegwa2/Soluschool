        ...
        <div className="max-w-6xl mx-auto py-6 px-4">
          ...
          {result && (
            <div id="scan-result" className={`result-card p-6 rounded-lg shadow mb-6 ${result.status}`}>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <strong>Child:</strong> <span id="result-child-name">Unknown</span>
                </div>
                <div>
                  <strong>Parent:</strong> <span id="result-parent-name">Unknown</span>
                </div>
                <div>
                  <strong>Phone:</strong> <span id="result-parent-phone">N/A</span>
                </div>
                <div>
                  <strong>Time:</strong> <span id="result-time">{new Date().toLocaleString()}</span>
                </div>
              </div>
              {result.reason && (
                <div className="mt-4">
