...
import { Search, ChevronUp, ChevronDown, Grid, List } from 'lucide-react'
...
export default function History() {
  ...
  const dummyLogs = [
    ...
    },
    {
      ...
      status: 'approved',
      notes: 'Picked up by grandmother'
    },
    {
      id: 5,
      child_name: 'Liam Johnson',
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex space-x-2">
                <button
                  ...
                  className={`p-2 rounded-lg ${viewMode === 'table' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-600'}`}
                  title="Table View"
                >
                  <List size={20} />
                </button>
                <button
                  ...
                  className={`p-2 rounded-lg ${viewMode === 'cards' ? 'bg-blue-500 text-white' : 'bg-gray-200 text-gray-600'}`}
                  title="Card View"
                >
                  <Grid size={20} />
                </button>
              ...
              {filteredLogs.map((log) => (
                <div key={log.id} className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                  <div className="flex justify-between items-start mb-4">
                    <h3 className="text-lg font-semibold text-gray-900">{log.child_name}</h3>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center text-sm text-gray-600">
                      ...
                      <span className="ml-2">{log.gate_name}</span>
                    </div>
                    <div className="flex items-center text-sm text-gray-600">
