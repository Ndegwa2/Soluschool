...
const fetcher = async (url) => {
  const response = await apiClient.get(`${url}?adminId=${getUserId()}`)
  if (response.success) {
  ...
  return (
    <div style={{ padding: '24px', backgroundColor: '#f4f6f8', minHeight: '100vh' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px' }}>
        <h1 style={{ fontSize: '24px', fontWeight: '600', color: '#111827', margin: 0 }}>Schools</h1>
        <button style={{
      ...
      <div style={{ display: 'flex', gap: '20px', marginBottom: '24px' }}>
        <div style={{
          ...
          <div style={{ fontSize: '14px', color: '#6b7280', marginBottom: '8px' }}>Total Schools</div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '24px', fontWeight: '700', color: '#111827' }}>{stats.active}</div>
        </div>
        <div style={{
          backgroundColor: '#ffffff',
          borderRadius: '12px',
          ...
          <div style={{ fontSize: '24px', fontWeight: '700', color: '#111827' }}>{stats.pending}</div>
        </div>
      </div>
      ...
      <div style={{
        ...
        <span>📁</span>
        <span style={{ fontSize: '14px', color: '#374151' }}>Bulk upload (CSV, XLSX)</span>
      </div>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <thead>
            <tr style={{ borderBottom: '1px solid #eef2f7' }}>
              ...
              <th style={{ padding: '16px', textAlign: 'left', fontWeight: '600', fontSize: '14px' }}>School</th>
              <th style={{ padding: '16px', textAlign: 'left', fontWeight: '600', fontSize: '14px' }}>Location</th>
          ...
          <tbody>
            {filteredSchools.map((school, index) => (
              ...
              >
                ...
                <td style={{ padding: '16px', fontSize: '14px', color: '#374151' }}>{school.name}</td>
                <td style={{ padding: '16px', fontSize: '14px', color: '#9ca3af' }}>{school.address || 'No address'}</td>
                <td style={{ padding: '16px' }}>
                  <span style={{
                    padding: '4px 12px',
                    borderRadius: '999px',
