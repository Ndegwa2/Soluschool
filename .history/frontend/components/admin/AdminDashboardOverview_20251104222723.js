    ...
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{
          ...
          <div style={{ width: '80px', fontSize: '12px', color: '#6b7280', fontWeight: '500' }}>Time</div>
          <div style={{ width: '160px', fontSize: '12px', color: '#6b7280', fontWeight: '500' }}>Visitor</div>
          <div style={{ width: '160px', fontSize: '12px', color: '#6b7280', fontWeight: '500' }}>Host</div>
          <div style={{ width: '220px', fontSize: '12px', color: '#6b7280', fontWeight: '500' }}>Purpose</div>
          <div style={{ width: '80px', fontSize: '12px', color: '#6b7280', fontWeight: '500' }}>Status</div>
        </div>
        ...
        {activities.map((activity, index) => (
          <div key={index} style={{
            ...
            <div style={{ width: '80px', fontSize: '13px', color: '#1f2937', fontWeight: '400' }}>{activity.time}</div>
            <div style={{ width: '160px', fontSize: '13px', color: '#1f2937', fontWeight: '400' }}>{activity.visitor}</div>
            <div style={{ width: '160px', fontSize: '13px', color: '#1f2937', fontWeight: '400' }}>{activity.host}</div>
            <div style={{ width: '220px', fontSize: '13px', color: '#1f2937', fontWeight: '400' }}>{activity.purpose}</div>
            <div style={{
              width: '80px',
              height: '24px',
              ...
              fontSize: '12px',
              fontWeight: '500',
              color: activity.status === 'checked-in' || activity.status === 'blacklisted' ? '#ffffff' : '#1f2937'
            }}>
...
const AdminDashboardOverview = () => {
  ...
  const stats = [
    { title: 'Visitors Today', value: analytics?.visitors_today || 128, color: '#172b4d', icon: '👥' },
