        ...
        <nav style={{
          ...
          {role === 'admin' && (
            <Link href="/admin" style={{
              textDecoration: 'none',
              color: router.pathname === '/admin' ? '#0ea5e9' : '#0b1220',
              opacity: router.pathname === '/admin' ? 1 : 0.85,
              fontWeight: 600,
              textUnderlineOffset: '6px',
              textDecoration: router.pathname === '/admin' ? 'underline' : 'none'
            }}>Dashboard</Link>
          )}
          <Link href="/history" style={{
            textDecoration: 'none',
            color: router.pathname === '/history' ? '#0ea5e9' : '#0b1220',
            opacity: router.pathname === '/history' ? 1 : 0.85,
            fontWeight: 600,
            textUnderlineOffset: '6px',
            textDecoration: router.pathname === '/history' ? 'underline' : 'none'
          }}>History</Link>
        </nav>
